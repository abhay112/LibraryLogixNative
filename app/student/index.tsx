...
// Feature cards matching the reference UI - Student routes
const featureCards = [
  { title: 'Students', icon: 'person', color: '#5AC8FA', route: '/student/students' },
  { title: 'Attendance', icon: 'event', color: '#007AFF', route: '/student/attendance' },
  { title: 'Seats', icon: 'schedule', color: '#FF9500', route: '/student/seats' },
  { title: 'Fees', icon: 'account-balance-wallet', color: '#34C759', route: '/student/fees' },
  { title: 'Inquery', icon: 'comment', color: '#007AFF', route: '/queries/submit' },
  { title: 'Inactive Students', icon: 'person-off', color: '#007AFF', route: '/student/attendance' },
];
